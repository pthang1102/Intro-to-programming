...
# To begin, you are a programming engineer coming to your new work-place for the 1st time!
# Let's discover!
...
def second_floor(items):
    ...
    if "handbook" in items:
        ...
        if "ID card" in items:
            print_pause("He looks at your ID card and then gives you a copy of the "
                        "employee handbook.\n")
            items.append("handbook")
        else:
            print_pause("He has something for you, but says he can't give it to you until "
...
def third_floor(items):
    ...
    if "ID card" in items:
        ...
        if "handbook" in items:
            ...
            print_pause("Congratulations! You are ready to start your new jobs as vice "
                        "president of engineering!\n")
        else:
            print_pause("They scowl when they see that you don't have it, and send you "
                        "back to the elevator.\n")
    else:
        print_pause("Unfortunately, the door is locked and you can't get in.\n")
        print_pause("It looks like you need some kind of key to open the door.\n")
...
def elevator(items):
    ...
    if response == "1":
        ...
        print_pause("I don't understand your input.") # Handle incorrect user input
        elevator(items)
